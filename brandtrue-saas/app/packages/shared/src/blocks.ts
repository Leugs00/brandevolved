...
export const blockDefs: Record<string, BlockDef> = {
  ...
  intro_split: {
    ...
    fields: {
      ...
      image_width: { type: "select", label: "Photo share", options: ["half", "wide"], help: "Half = text and photo split evenly. Wide = the photo gets the bigger share of the row." },
    ...
    schema: z
      .object({
        ...
        image_width: z.enum(["half", "wide"]).default("half"),
