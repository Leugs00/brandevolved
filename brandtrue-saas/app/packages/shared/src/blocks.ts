...
export const blockDefs: Record<string, BlockDef> = {
  ...
  intro_split: {
    ...
    fields: {
      ...
      image_width: { type: "select", label: "Photo share", options: ["half", "wide", "narrow"], help: "Half = even split. Wide = photo gets more room. Narrow = photo smaller, text column wider (~57%)." },
    ...
    schema: z
      .object({
        ...
        image_width: z.enum(["half", "wide", "narrow"]).default("half"),
